...
<section className="flex flex-col justify-center">
  ...
  <p className="mt-4 max-w-xl text-lg text-zinc-400">
    Turn your eCommerce data into clear, actionable insights.
    Track revenue, orders, customers, and product performance,
    analyze trends, and forecast future sales from one powerful dashboard.
  </p>

  <div className="mt-6 space-y-2 text-sm text-zinc-500">
    <p>📊 Revenue & performance analytics</p>
    <p>🛒 Orders & customer insights</p>
    <p>📦 Product performance tracking</p>
    <p>📈 Trends & revenue forecasting</p>
  </div>
</section>
